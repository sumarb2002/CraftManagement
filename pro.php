...
label{
  ...
  <form style="width:400px;height:520px;text-align:center;background:#E7E8F3;position:absolute;left:440px;top:70px;box-shadow: 0px 5px 10px 0px #aaa;">
        <h2 style="color:green;left:120px;top:10px;position:absolute;font-size:35px;">My Profile</h2><br>
        <hr style="border:1px solid gray;margin-bottom:25px;position:absolute;top:50px;width:400px;">
