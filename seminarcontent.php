...
top:150px;
     ...
     padding: 30px;
    background: rgb(219, 218, 218);
    border-radius: 15px;" action="seminarcontent2.php" method="POST">
    <h1 style="text-align: center;">Join Seminar</h1><br>
...
<button class="btn btn-primary" type="submit" style="position:absolute;left:170px;background:blue;width:150px;">JOIN</button><br><br>
